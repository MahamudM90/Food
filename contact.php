		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="contact.php"><img src="img/header/nav-icon8.png" alt="">contact</a></li>
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<h1>Contact Us</h1>
							<p>You can contact with our support team(Dominator's) anytime.</p>
							<p>We'll help you as soon as possible.</p>
							<p>Thank You so much, Stay with us.</p>
						</div>
					...
					<div class="col-lg-3">
						<div class="contact_info">
							<div class="info_item">
								...
								<h6>Dhanmondi, Bangladesh</h6>
								<p>Dominator's</p>
							</div>
							<div class="info_item">
								<i class="lnr lnr-phone-handset"></i>
								<h6><a href="#">01627510660</a></h6>
								<p>Sat to Fri 10am to 10 pm</p>
							</div>
							<div class="info_item">
								<i class="lnr lnr-envelope"></i>
								<h6><a href="#">support@dominator's.com</a></h6>
								<p>Send us your query anytime!</p>
							</div>
						</div>
					</div>
					<div class="col-lg-9">
						<form class="row contact_form" action="contactconnect.php" method="POST" id="contactForm" novalidate="novalidate">
							<div class="col-md-6">
