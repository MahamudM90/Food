...
<body>
		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="about-us.php"><img src="img/header/nav-icon2.png" alt="">about</a></li>
	...
	<div class="site-main">
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<h1>About Us</h1>
							<p> Food Hunting is a restaurants providing the best food in your town.

								Therefore, it’s only natural that About Us page features a compilation of various they provide.
		...
		<div class="col-lg-12 col-md-10">
							<div class="banner-btn">
								<center><a class="primary-btn text-uppercase" href="contact.php">Dominator's</a></center>
							</div>
						</div>
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-5">
						<div class="left-content">
							<h1>Mahamud Hasan</h1>
							<p>B.S.C in Computer Science & Engineering</p>
					...
					<div class="col-lg-6 offset-lg-1">
						<div class="right-img">
							<img class="img1 img-fluid" src="img/food/c.jpg" alt="">
		...
		<div class="breakfast-area lunch-area section_gap">
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-6 ">
						<div class="right-img">
							<img class="img1 img-fluid" src="img/food/d.jpg" alt="">
